...
function RegisterPage() {
  ...
  const pwdStrength = (() => {
    ...
    if (/[A-Z]/.test(password) || /[\u0600-\u06FF]/.test(password)) s++;
  ...
  const handleSubmit = async (ev: React.FormEvent) => {
    ...
    toast.success(`تم إنشاء حسابك كـ ${ROLES.find((r) => r.value === role)?.label}`);
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-10">
        ...
        >
          ...
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">انضم خلال أقل من دقيقة وابدأ الطلب فوراً</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <p className="text-[11px] leading-relaxed text-slate-500">
              ...
              <span className="font-semibold text-emerald-600">شروط الاستخدام</span> و{" "}
